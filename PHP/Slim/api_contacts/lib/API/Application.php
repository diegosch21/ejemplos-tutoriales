...
{
    /* 
     * Ensures that the provided data is sanitized and performs basic validation; 
     * it makes sure that we have at least a first name and a unique valid email address 
     */
