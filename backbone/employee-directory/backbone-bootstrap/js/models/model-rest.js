...
directory.Employee = Backbone.Model.extend({
    ...
    urlRoot:"http://localhost/ejemplos/backbone/employee-directory/api-rest-php/employees",
...
directory.EmployeeCollection = Backbone.Collection.extend({
    ...
    url:"http://localhost/ejemplos/backbone/employee-directory/api-rest-php/employees",
